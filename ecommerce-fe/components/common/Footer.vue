    ...
    <footer class="bg-gradient-to-b from-gray-800 to-gray-900 text-white">
        <div class="container mx-auto px-4 py-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="space-y-4">
                    <h3
                        class="text-xl font-bold mb-4 border-b-2 border-blue-500 inline-block pb-2"
                    >
                        About Us
                    </h3>
                    <p class="text-gray-300">
                        E-Shop is your one-stop destination for all your
                        shopping needs. We provide quality products and
                        excellent customer service.
                    </p>
                </div>
                <div class="space-y-4">
                    <h3
                        class="text-xl font-bold mb-2 border-b-2 border-blue-500 inline-block pb-2"
                    >
                        Customer Service
                    </h3>
                    <ul class="space-y-2">
            ...
            <div class="mt-5 pt-2 border-t border-gray-700 text-center">
